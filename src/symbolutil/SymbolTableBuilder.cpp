...
void SymbolTableBuilder::buildForStatements(statement *stmt)
{
  ...
  case NODE_FORALLSTMT:
  {
    ...
    if ((backend.compare("omp") == 0) || (backend.compare("amd") == 0) || (backend.compare("cuda") == 0) || (backend.compare("multigpu") == 0)|| (backend.compare("acc") == 0) || (backend.compare("mpi") == 0) || (backend.compare("sycl") == 0) || (backend.compare("webgpu") == 0))
    {
      if (parallelConstruct.size() > 0)
      {
    ...
    if ((backend.compare("amd") == 0) || backend.compare("cuda") == 0 || (backend.compare("sycl") == 0) || (backend.compare("multigpu") == 0) || (backend.compare("webgpu") == 0))
    ...
    if ((backend.compare("omp") == 0 || backend.compare("amd") == 0 || backend.compare("cuda") == 0 || (backend.compare("multigpu") == 0)|| backend.compare("acc") == 0 || backend.compare("mpi") == 0 || (backend.compare("sycl") == 0) || (backend.compare("webgpu") == 0)) && forAll->isForall())
    {
      if (forAll->isForall())
      {
        parallelConstruct.pop_back();
  ...
  case NODE_LOOPSTMT:
  {
    ...
    string backend(backendTarget);
    if ((backend.compare("cuda") == 0) || (backend.compare("omp") == 0) || (backend.compare("webgpu") == 0) )
    {
      if (parallelConstruct.size() > 0)
      {
        loop->disableLoop();
  ...
  case NODE_BLOCKSTMT:
  {
    ...
    if (flag && (backend.compare("omp") == 0 || backend.compare("acc") == 0 || backend.compare("webgpu") == 0))
  ...
  case NODE_REDUCTIONCALLSTMT:
  {
    ...
    if (reducStmt->is_reducCall())
    {
      ...
      if (leftList.size() > 2)
      {
        ...
        if (backend.compare("omp") == 0 || backend.compare("acc") || backend.compare("webgpu") == 0)
