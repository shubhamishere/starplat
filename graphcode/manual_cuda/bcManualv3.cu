//all graph related header files are in 'starplat/graphcode' location
//compile:
//nvcc bcManualv3.cu

//run: 1st argument graph input text file in edge list format, 2nd argument sourceSet input text file
//./a.out graphFile.txt srcSetFile.txt -p

//take small graphs as input, it displays bc values for 0 to 8 nodes only.

#include <stdio.h>
#include <stdlib.h>
#include <limits.h>
#include <cuda.h>
#include "../graph.hpp"     //all graph related header files are in 'starplat/graphcode' location
#include <random>
#include <sstream>
#include <fstream>
#include <string>
